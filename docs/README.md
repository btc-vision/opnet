...
- [OPNet GitHub](https://github.com/btc-vision/opnet)
- [OPNet Website](https://opnet.org)
- [Example Utils](https://github.com/btc-vision/opnet-utils)
...
| Feature | Support |
|---------|---------|
| JSON-RPC Provider | Full |
| WebSocket Provider | Full |
| Smart Contract Calls | Full |
| Transaction Building | Full |
| UTXO Management | Full |
| Block Operations | Full |
| Epoch Mining | Full |
| Event Decoding | Full |
| Offline Signing | Full |

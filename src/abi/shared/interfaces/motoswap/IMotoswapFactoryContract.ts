...
export interface IMotoswapFactoryContract extends IOP_NETContract {
     ...
     * @returns {Promise<CallResult<{ address: Address }>>} Return the requested pool virtual address as bigint.
     */
    getPool(token0: Address, token1: Address): Promise<CallResult<{ address: Address }>>;
